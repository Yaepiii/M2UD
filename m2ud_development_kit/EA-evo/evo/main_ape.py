...
def ape(traj_ref: PosePath3D, traj_est: PosePath3D,
        ...
        time_consumption_path: str = "",
        sensor_frequency: float = -1000000) -> Result:
    ...
    if time_consumption_path == "" or sensor_frequency == -1000000:
        # Calculate APE.
        logger.debug(SEP)
        ...
        data = (traj_ref, traj_est)
        ape_metric = metrics.APE(pose_relation)
        ape_metric.process_data_with_efficiency(data=data,
                                time_consumption_path=time_consumption_path,
...
def run(args: argparse.Namespace) -> None:
    ...
    result = ape(traj_ref=traj_ref, traj_est=traj_est,
                 ...
                 project_to_plane=plane, time_consumption_path=args.time_consumption, sensor_frequency=args.sensor_frquency)
